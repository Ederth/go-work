...
type Data struct {
	...
	Mq       map[string]*Data_RabbitMq `protobuf:"bytes,3,rep,name=mq,proto3" json:"mq,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (x *Data) GetMq() map[string]*Data_RabbitMq {
	if x != nil {
		return x.Mq
	}
	return nil
...
type Data_RabbitMq struct {
	...
	Exchange      *Data_RabbitMq_Exchange `protobuf:"bytes,3,opt,name=exchange,proto3" json:"exchange,omitempty"`
	Queue         *Data_RabbitMq_Queue    `protobuf:"bytes,4,opt,name=queue,proto3" json:"queue,omitempty"`
	PublishNum    int32                   `protobuf:"varint,5,opt,name=publish_num,json=publishNum,proto3" json:"publish_num,omitempty"`
	ConsumerNum   int32                   `protobuf:"varint,6,opt,name=consumer_num,json=consumerNum,proto3" json:"consumer_num,omitempty"`
...
func (x *Data_RabbitMq) GetExchange() *Data_RabbitMq_Exchange {
	if x != nil {
		return x.Exchange
	}
	return nil
...
func (x *Data_RabbitMq) GetQueue() *Data_RabbitMq_Queue {
	if x != nil {
		return x.Queue
	}
	return nil
...
func (x *Data_RabbitMq) GetPublishNum() int32 {
	if x != nil {
		return x.PublishNum
	}
	return 0
...
func (x *Data_RabbitMq) GetConsumerNum() int32 {
	if x != nil {
...
type Data_RabbitMq_Exchange struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *Data_RabbitMq_Exchange) Reset() {
	*x = Data_RabbitMq_Exchange{}
	if protoimpl.UnsafeEnabled {
...
func (x *Data_RabbitMq_Exchange) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Data_RabbitMq_Exchange) ProtoMessage() {}

func (x *Data_RabbitMq_Exchange) ProtoReflect() protoreflect.Message {
	mi := &file_internal_conf_conf_proto_msgTypes[9]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Data_RabbitMq_Exchange.ProtoReflect.Descriptor instead.
func (*Data_RabbitMq_Exchange) Descriptor() ([]byte, []int) {
	return file_internal_conf_conf_proto_rawDescGZIP(), []int{2, 2, 0}
}

func (x *Data_RabbitMq_Exchange) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *Data_RabbitMq_Exchange) GetKind() string {
	if x != nil {
		return x.Kind
	}
	return ""
...
type Data_RabbitMq_Queue struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *Data_RabbitMq_Queue) Reset() {
	*x = Data_RabbitMq_Queue{}
	if protoimpl.UnsafeEnabled {
...
func (x *Data_RabbitMq_Queue) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Data_RabbitMq_Queue) ProtoMessage() {}

func (x *Data_RabbitMq_Queue) ProtoReflect() protoreflect.Message {
	mi := &file_internal_conf_conf_proto_msgTypes[10]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Data_RabbitMq_Queue.ProtoReflect.Descriptor instead.
func (*Data_RabbitMq_Queue) Descriptor() ([]byte, []int) {
	return file_internal_conf_conf_proto_rawDescGZIP(), []int{2, 2, 1}
}

func (x *Data_RabbitMq_Queue) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
var file_internal_conf_conf_proto_rawDesc = []byte{
	...
	0x22, 0xad, 0x07, 0x0a, 0x04, 0x44, 0x61, 0x74, 0x61, 0x12, 0x35, 0x0a, 0x08, 0x64, 0x61, 0x74,
	...
	0x61, 0x2e, 0x52, 0x65, 0x64, 0x69, 0x73, 0x52, 0x05, 0x72, 0x65, 0x64, 0x69, 0x73, 0x12, 0x28,
	0x0a, 0x02, 0x6d, 0x71, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x18, 0x2e, 0x6b, 0x72, 0x61,
	0x74, 0x6f, 0x73, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x44, 0x61, 0x74, 0x61, 0x2e, 0x4d, 0x71, 0x45,
	0x6e, 0x74, 0x72, 0x79, 0x52, 0x02, 0x6d, 0x71, 0x1a, 0x3a, 0x0a, 0x08, 0x44, 0x61, 0x74, 0x61,
	...
	0x65, 0x6f, 0x75, 0x74, 0x1a, 0xe7, 0x02, 0x0a, 0x08, 0x52, 0x61, 0x62, 0x62, 0x69, 0x74, 0x4d,
	0x71, 0x12, 0x12, 0x0a, 0x04, 0x61, 0x64, 0x64, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x04, 0x61, 0x64, 0x64, 0x72, 0x12, 0x14, 0x0a, 0x05, 0x76, 0x68, 0x6f, 0x73, 0x74, 0x18, 0x02,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x76, 0x68, 0x6f, 0x73, 0x74, 0x12, 0x3e, 0x0a, 0x08, 0x65,
	...
	,
	...
	0x64, 0x1a, 0x1b, 0x0a, 0x05, 0x51, 0x75, 0x65, 0x75, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61,
	0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x1a, 0x50,
	0x0a, 0x07, 0x4d, 0x71, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x12, 0x10, 0x0a, 0x03, 0x6b, 0x65, 0x79,
	...
	0x42, 0x22, 0x5a, 0x20, 0x77, 0x7a, 0x2d, 0x63, 0x61, 0x72, 0x2d, 0x77, 0x6f, 0x72, 0x6b, 0x65,
...
var file_internal_conf_conf_proto_goTypes = []interface{}{
	...
	nil,                            // 8: kratos.api.Data.MqEntry
	(*Data_RabbitMq_Exchange)(nil), // 9: kratos.api.Data.RabbitMq.Exchange
	(*Data_RabbitMq_Queue)(nil),    // 10: kratos.api.Data.RabbitMq.Queue
...
var file_internal_conf_conf_proto_depIdxs = []int32{
	...
	8,  // 6: kratos.api.Data.mq:type_name -> kratos.api.Data.MqEntry
	...
	11, // 9: kratos.api.Data.Redis.dial_timeout:type_name -> google.protobuf.Duration
	...
	9,  // 12: kratos.api.Data.RabbitMq.exchange:type_name -> kratos.api.Data.RabbitMq.Exchange
	10, // 13: kratos.api.Data.RabbitMq.queue:type_name -> kratos.api.Data.RabbitMq.Queue
	7,  // 14: kratos.api.Data.MqEntry.value:type_name -> kratos.api.Data.RabbitMq
...
func file_internal_conf_conf_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_internal_conf_conf_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Data_RabbitMq_Exchange); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_internal_conf_conf_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Data_RabbitMq_Queue); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
